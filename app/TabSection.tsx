  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ fontSize: 12, color: "#2e7d32", fontWeight: 600, marginBottom: 2 }}>
      ...
      <a href={"/" + app.slug} style={{
        ...
        whiteSpace: "nowrap", flexShrink: 0, display: "block",
        textAlign: "center",
      }}>
        ⬇ Download
      </a>
...
export default function TabSection({ topRated, newGames, otherGames }: Props) {
  ...
  return (
    <div>
      ...
      {/* Section Title */}
      <h2 style={{ fontSize: 16, fontWeight: 700, color: "#1a1a1a", marginBottom: 14, margin: "0 0 14px" }}>
        {activeLabel} Apps
      </h2>
